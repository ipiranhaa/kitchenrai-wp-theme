									...
									'options' => array(
										'body-background-type' => array(
											...
											'options' => array(
												...
												'pattern'=>__('Pattern', 'gdlr_translate')
											),
											'default' => 'none'
										),
										'body-background-pattern' => array(
											...
											'type' => 'radioimage',
											'options' => array(
												'1'=>GDLR_PATH . '/include/images/bg-pattern/pattern-1.jpg',
												'2'=>GDLR_PATH . '/include/images/bg-pattern/pattern-2.jpg',
												'3'=>GDLR_PATH . '/include/images/bg-pattern/pattern-3.jpg',
												'4'=>GDLR_PATH . '/include/images/bg-pattern/pattern-4.jpg',
												'5'=>GDLR_PATH . '/include/images/bg-pattern/pattern-5.jpg',
												'6'=>GDLR_PATH . '/include/images/bg-pattern/pattern-6.jpg',
												'7'=>GDLR_PATH . '/include/images/bg-pattern/pattern-7.jpg',
												'8'=>GDLR_PATH . '/include/images/bg-pattern/pattern-8.jpg',
												'9'=>GDLR_PATH . '/include/images/bg-pattern/pattern-9.jpg',
												'10'=>GDLR_PATH . '/include/images/bg-pattern/pattern-10.jpg',
												'11'=>GDLR_PATH . '/include/images/bg-pattern/pattern-11.jpg',
												'12'=>GDLR_PATH . '/include/images/bg-pattern/pattern-12.jpg',
												'13'=>GDLR_PATH . '/include/images/bg-pattern/pattern-13.jpg',
												'14'=>GDLR_PATH . '/include/images/bg-pattern/pattern-14.jpg',
											),
											'default'=>'1',
											'data-type'=>'text',
											'selector'=> '.body-wrapper.gdlr-pattern-background{ background-image: url("../images/bg-pattern/pattern-#gdlr#.jpg"); }',
											'wrapper-class'=>'body-background-type-wrapper pattern-wrapper'
										),									
										'body-background-image' => array(
											'title' => __('Background Image', 'gdlr_translate'),
											'type' => 'upload',
											'wrapper-class'=> 'body-background-type-wrapper image-wrapper'
										),	
						...
						'elements-color' => array(
							...
							'options' => array(
								...
								'main-navigation-color' => array(
									...
									'options' => array(
										...
										'header-background-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-header-wrapper, .gdlr-navigation-outer-wrapper{ background-color: #gdlr#; }'
										...
										'main-navigation-text-hover' => array(
											...
											'selector'=> '.gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, ' .
												...
												'.gdlr-navigation-gimmick{ background: #gdlr#; height: 2px; }'
										),	
										'main-navigation-border' => array(
											'title' => __('Main Navigation Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '.gdlr-navigation-outer-wrapper .gdlr-navigation-wrapper{ border-color: #gdlr#; }' .
												'.gdlr-navigation-wrapper .gdlr-main-menu > li > a:before{ color: #gdlr#; }'
										),
										...
										'menu-search-button-icon' => array(
											...
											'type' => 'colorpicker',
											'default' => '#a0a0a0',
											'selector'=> '.top-search-button i{ color: #gdlr#; }'
										),
								...
								'body-color' => array(
									...
									'options' => array(
										'body-background' => array(
											'title' => __('Body Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.body-wrapper{ background-color: #gdlr#; }'
										),	
										'container-backgrond' => array(
											'title' => __('Item Container Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-item.gdlr-blog-full, .gdlr-sidebar .widget.gdlr-item, .blog-item-filter, ' . 
												'.gdlr-item.gdlr-blog-medium, .gdlr-item.gdlr-blog-grid, .gdlr-with-background, ' . 
												'.gdlr-item.gdlr-author-item, .gdlr-pagination{ background-color: #gdlr#; }'
										),	
										'container-bottom-border' => array(
											'title' => __('Item Container Bottom Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e3e3e3',
											'selector'=> '.body-wrapper .gdlr-item.gdlr-blog-full, .gdlr-sidebar .widget.gdlr-item, ' . 
												'.body-wrapper .gdlr-item.gdlr-blog-medium, .body-wrapper .gdlr-item.gdlr-blog-grid, ' . 
												'.body-wrapper .gdlr-with-background, .body-wrapper .blog-item-filter, ' .
												'.body-wrapper .gdlr-author-item, .body-wrapper .gdlr-pagination{ border-bottom-color: #gdlr#; }'
										),
										...
										'heading-color' => array(
											...
											'selector'=> 'h1, h2, h3, h4, h5, h6, .gdlr-title, .gdlr-title a{ color: #gdlr#; } ' .
												'.post-author-title, .comment-reply-title, .gdlr-comments-area .comments-title, .related-post-title{ border-color: #gdlr#; } ' .
												'.single-post .gdlr-single-nav, .single-post .gdlr-single-nav a{ color: #gdlr#; border-color: #gdlr#; }' . 
												'.gdlr-title-background{ background-color: #gdlr#; border-color: #gdlr#; } '
										),		
								...
								'sidebar-color' => array(
									...
									'options' => array(
										'sidebar-title-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#383838',
											'selector'=> '.gdlr-sidebar .gdlr-widget-title{ color: #gdlr#; border-color: #gdlr#; }'
										),	
										...
										'instagram-icon' => array(
											'title' => __('Instagram/Twitter Icon Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#151515',
											'selector'=> '.gdlr-sidebar .gdlr-nav-container .icon-twitter, .gdlr-sidebar .icon-instagram, .gdlr-sidebar .gdlr-instagram-list-link a{ color: #gdlr#; }'
										),
										'instagram-nav-icon' => array(
											'title' => __('Instagram/Twitter Navigation Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#909090',
											'selector'=> '.gdlr-sidebar .gdlr-nav-container .gdlr-flex-prev, .gdlr-sidebar .gdlr-nav-container .gdlr-flex-next{ border-color: #gdlr#; color: #gdlr#; }'
										),
									)
								),
								...
								'content-item-1' => array(
									...
									'options' => array(		
										...
										'button-text-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#3f3f3f',
											'selector'=> '.gdlr-button, .gdlr-button:hover, ' . 
										...
										'button-background-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
											'selector'=> '.gdlr-button{ background-color: #gdlr#; }'
										),											
										'button-with-border-color' => array(
											'title' => __('Button With Border Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#1b1b1b',
											'selector'=> '.gdlr-button.with-border, input[type="button"], input[type="submit"]{ color: #gdlr#; }'
										),
										'button-border-color' => array(
											'title' => __('Button Border Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#383838',
											'selector'=> '.gdlr-button.with-border, input[type="button"], input[type="submit"]{ border: 2px solid #gdlr#; }'
										),
										'button-inner-border-color' => array(
											'title' => __('Button Inner Border Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#383838',
											'selector'=> '.gdlr-button.with-border, input[type="button"], input[type="submit"]{ outline: 1px solid #gdlr#; }'
										),										
								...
								'blog-color' => array(
									...
									'options' => array(
										...
										'blog-info-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#c1c1c1',
											'selector'=> '.gdlr-blog-info, .gdlr-blog-info a, .gdlr-blog-info i{ color: #gdlr#; }'
										),
								...
								'pagination-color' => array(
									'title' => __('Blog / Pagination', 'gdlr_translate'),
									'options' => array(
										'blog-full-date-day' => array(
											'title' => __('Blog Full Date Day', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#1b1b1b',
											'selector'=> '.gdlr-blog-full .blog-date-day{ color: #gdlr#; border-bottom-color: #gdlr#; }'
										),	
										'blog-full-date-month' => array(
											'title' => __('Blog Full Date Month', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#8c8c8c',
											'selector'=> '.gdlr-blog-full .blog-date-month{ color: #gdlr#; }'
										),
										'blog-full-date-year' => array(
											'title' => __('Blog Full Date Year', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#a2a2a2',
											'selector'=> '.gdlr-blog-full .blog-date-year{ color: #gdlr#; }'
										),	
										'blog-full-calendar-icon' => array(
											'title' => __('Blog Full Calendar Icon', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#dedede',
											'selector'=> '.gdlr-blog-full .blog-date-wrapper .icon-calendar-empty, .format-link .gdlr-link-format-icon{ color: #gdlr#; }'
										),
										'blog-filter-color' => array(
											'title' => __('Blog Filter Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#b6b6b6',
											'selector'=> '.blog-item-filter, .blog-item-filter a{ color: #gdlr#; }'
										),
										'blog-filter-hover-color' => array(
											'title' => __('Blog Filter Hover/Active Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#252525',
											'selector'=> '.blog-item-filter a:hover, .blog-item-filter a.active{ color: #gdlr#; }'
										),
								...
								'slider-input-color' => array(
									...
									'options' => array(
										...
										'input-box-background' => array(
											...
											'type' => 'colorpicker',
											'default' => '#f7f7f7',
											'selector'=> 'input[type="text"], input[type="email"], input[type="password"], textarea, .gdlr-comments-area .comment-body{ background-color: #gdlr#; }'
										),
								...
								'footer-color' => array(
									...
									'options' => array(
										...
										'footer-button-border-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.footer-wrapper input[type="button"], ' . 
												'.footer-wrapper input[type="submit"]{ border-color: #gdlr#; outline-color: #gdlr#; }'
										),											
