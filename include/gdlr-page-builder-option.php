			...
			$title = array(
				'title-type'=> array(	
					...
					'options'=> array(
						...
						'left-large'=> __('Left Align Large' ,'gdlr_translate'),
						'left'=> __('Left Align Small' ,'gdlr_translate'),
						'center-large'=> __('Center Align Large' ,'gdlr_translate'),
						'center'=> __('Center Align Small' ,'gdlr_translate')
					)
				),										
				'title'=> array(	
					'title'=> __('Title' ,'gdlr_translate'),
					'type'=> 'text',
					'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper left-large-wrapper center-large-wrapper'
				),			
				'caption'=> array(	
									...
									'options'=>array(
										'background-type' => array(
											...
											'options' => array(
												...
												'full-color'=>__('Full Width Color', 'gdlr_translate'),
						...
						'content-item' => array(
							...
							'options' => array(
								...
								'author' => array(
									...
									'options'=>array(
										'column'=> array(
											'title'=> __('Column' ,'gdlr_translate'),
											'type'=> 'combobox',						
											'options'=> array(
												'1/4'=> __('1/4','gdlr_translate'),		
												'1/3'=> __('1/3','gdlr_translate'),		
												'1/2'=> __('1/2','gdlr_translate'),		
												'1/1'=> __('1/1','gdlr_translate')
											)
										),		
										'orderby'=> array(
											...
											'type'=> 'combobox',						
											'options'=> array(
												'ID'=> __('ID','gdlr_translate'),		
												'name'=> __('Name','gdlr_translate'),		
												'nicename'=> __('Nice Name','gdlr_translate'),		
												'post_count'=> __('Post Count','gdlr_translate')
											)
										),
										'order'=> array(
											...
											'type'=> 'combobox',						
											'options'=> array(
												'asc'=> __('Ascending','gdlr_translate'),		
												'desc'=> __('Descending','gdlr_translate')
											)
										),
										'margin-bottom' => array(
											'title' => __('Margin Bottom', 'gdlr_translate'),
								...
								'blog' => array(
									...
									'options'=> array_merge(gdlr_page_builder_title_option(true), array(										
										...
										'enable-jquery-filter'=> array(
											'title'=> __('Enable Filterable' ,'gdlr_translate'),
											'type'=> 'checkbox',
											'default'=> 'disable',
											'description'=> __('You have to select only 1 parent category ( with fitrows or masonry layout for blog grid ) while enabling this option.','gdlr_translate')
										),
										...
										'offset'=> array(
											...
											'type'=> 'text',
											'description'=> __('Fill in number of the posts you want to skip. Please noted that this will not works well with pagination and filter option', 'gdlr_translate')
										),										
										'pagination'=> array(
