	...
	if( !function_exists('gdlr_print_item') ){
		function gdlr_print_item( $content ){
			switch ($content['type']){
				...
				case 'author': echo gdlr_get_author_item($content['option']); break;
	...
	if( !function_exists('gdlr_print_color_wrapper') ){
		function gdlr_print_color_wrapper( $content ){
			...
			if( !empty($content['option']['background']) || !empty($padding) ){
				echo 'style="';
				if( !empty($content['option']['background-type']) && $content['option']['background-type'] == 'full-color' ){
			...
			$inner_container = false; $inner_style = '';
			if( empty($content['option']['background-type']) || $content['option']['background-type'] == 'color' ){
				$inner_container = true;
				$inner_style = ' style="background-color: ' . $content['option']['background'] . ';" ';
			}
			
			echo '<div class="container">';
			echo ($inner_container)? '<div class="gdlr-color-inner-wrapper" ' . $inner_style . '>': '';
