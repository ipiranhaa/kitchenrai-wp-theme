		...
		function gdlr_get_default_admin_option() {
			...
			if(empty($sidebar_option)){
				update_option('gdlr_sidebar_name', 
					array( 'blog', 'blog-left', 'shortcodes',  'Features', 'Archives', 'contact', 'homepage')
				);
			}
			
			$google_font_list = get_option(THEME_SHORT_NAME . '_google_font_list', array());
			if( empty($google_font_list) ){
				$font_text  = 'a:2:{s:12:"Merriweather";a:2:{s:7:"subsets";a:2:{i:0;s:5:"latin";i:1;s:9:"latin-ext";}s:8:"variants";a:8:{i:0;s:3:"300";i:1;s:9:"300italic";i:2;s:7:"regular";i:3;s:6:"italic";i:4;s:3:"700";i:5;s:9:"700italic";i:6;s:3:"900";i:7;s:9:"900italic";}}s:4:"Arvo";a:2:{s:7:"subsets";a:1:{i:0;s:5:"latin";}s:8:"variants";a:4:{i:0;s:7:"regular";i:1;s:6:"italic";i:2;s:3:"700";i:3;s:9:"700italic";}}}';
	...
	<article id="comment-<?php comment_ID(); ?>" class="comment-article">
		...
		<div class="comment-body">
			<header class="comment-meta">
				...
				<div class="comment-reply"><?php comment_reply_link( array_merge($args, array('reply_text' => __('Reply', 'gdlr_translate'), 'depth' => $depth, 'max_depth' => $args['max_depth'])) ); ?></div>				
			</header>
