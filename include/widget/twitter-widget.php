	...
	class Goodlayers_Twitter_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			if( empty($type) || $type == 'list' ){
				...
				echo '<div class="gdlr-twitter-item gdlr-widget-style" >';
				echo '<div class="gdlr-twitter-item-head gdlr-nav-container" >';
				echo '<i class="icon-angle-left gdlr-flex-prev"></i>';
				echo '<a href="https://twitter.com/' . $twitter_username . '" target="_blank" ><i class="icon-twitter"></i></a>';
				echo '<i class="icon-angle-right gdlr-flex-next"></i>';
				echo '</div>';

				echo '<div class="gdlr-twitter-item-wrapper" >';
				echo '<div class="flexslider" data-type="carousel" data-nav-container="gdlr-twitter-item-wrapper" >';
