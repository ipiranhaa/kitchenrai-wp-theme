					...
					'page-option' => array(
						...
						'options' => array(
							...
							'show-content' => array(
								...
								'type' => 'combobox',
								'options' => array(
									'enable' => __('Show Content With Background' , 'gdlr_translate'),
									'no-background' => __('Show Content Without Background' , 'gdlr_translate'),
									'disable' => __('Hide Content' , 'gdlr_translate')
								),
								'default' => 'enable',
							)				
						)
